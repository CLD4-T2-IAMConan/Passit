...
# Dev 환경에 서비스 Pod 배포 스크립트
# 사용법: ./terraform/scripts/deploy-services-dev.sh
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}🚀 Dev 환경 서비스 Pod 배포${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
# 클러스터 이름 가져오기
CLUSTER_NAME=$(terraform output -raw cluster_name 2>/dev/null || echo "passit-dev-eks")
...
if ! kubectl get namespace services > /dev/null 2>&1; then
    echo -e "${YELLOW}  ⚠️  Namespace 'services'가 없습니다. 생성합니다...${NC}"
    kubectl create namespace services
    echo -e "${GREEN}  ✅ Namespace 'services' 생성 완료${NC}"
else
    echo -e "${GREEN}  ✅ Namespace 'services' 존재함${NC}"
fi
...
# Pod 상태 확인
echo "Pod 상태:"
if kubectl get pods -n services > /dev/null 2>&1; then
    kubectl get pods -n services
else
    echo -e "${YELLOW}  ⚠️  Pod가 아직 생성되지 않았습니다.${NC}"
    echo "  ArgoCD가 리소스를 배포하는 중입니다. 잠시 후 다시 확인하세요."
fi
echo ""
...
echo ""
echo "  # Pod 상태 확인:"
echo "  kubectl get pods -n services -w"
echo ""
echo "  # 상세 상태 확인:"
